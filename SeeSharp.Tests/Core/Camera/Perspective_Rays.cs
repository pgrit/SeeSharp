...
namespace SeeSharp.Tests.Core.Camera {
    public class Perspective_Rays {
        ...
        public void Directions_TopLeft() {
            ...
            // top left corner
            RNG rng = new();
            var ray = cam.GenerateRay(new Vector2(0, 0), ref rng).Ray;
        ...
        public void Directions_Center() {
            ...
            // image center
            RNG rng = new();
            var ray = cam.GenerateRay(new Vector2(1.5f, 1.5f), ref rng).Ray;
        ...
        public void Directions_Left() {
            ...
            // left center
            RNG rng = new();
            var ray = cam.GenerateRay(new Vector2(0, 1.5f), ref rng).Ray;
        ...
        public void Directions_Right() {
            ...
            // left center
            RNG rng = new();
            var ray = cam.GenerateRay(new Vector2(3, 1.5f), ref rng).Ray;
        ...
        public void Directions_BottomRight() {
            ...
            // bottom left corner
            RNG rng = new();
            var ray = cam.GenerateRay(new Vector2(3, 3), ref rng).Ray;
