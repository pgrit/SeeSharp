...
namespace SeeSharp.Core {
    public abstract class Filter {
        public abstract void Apply(Image original, Image target);
    }
    ...
    public class BoxFilter {
        ...
        ColorRGB Kernel(Image original, int centerRow, int centerCol) {
        ...
        public void Apply(Image original, Image target) {
